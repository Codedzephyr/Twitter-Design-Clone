  ...
  return (
    <section>
      <div className="overallContainer">
        ...
        {/* closing of twitter logo container */}

        {/* opening of buttons container for navigation */}
        <div className="buttonsContainer">
          ...
          <div className="flexContainer">
            ...
            <div className="textContainer">
              <p className="textholder">Home</p>
            </div>
          </div>
          {/* closing of home container */}
          ...
          <div className="flexContainer1">
            ...
            <div className="textContainer">
              <p className="textholder">Explore</p>
            </div>
          </div>
          ...
          <div className="flexContainer2">
            ...
            <div className="textContainer">
              <p className="textholder">Notifications</p>
            </div>
          </div>
          ...
          <div className="flexContainer3">
            ...
            <div className="textContainer">
              <p className="textholder">Messages</p>
            </div>
          </div>
          ...
          <div className="flexContainer4">
            ...
            <div className="textContainer">
              <p className="textholder">Bookmarks</p>
            </div>
          </div>
          ...
          <div className="flexContainer5">
            ...
            <div className="textContainer">
              <p className="textholder">Lists</p>
            </div>
          </div>
          ...
          <div className="flexContainer6">
            ...
            <div className="textContainer">
              <p className="textholder">Profile</p>
            </div>
          </div>
        ...
        <div className="tweetButtonContainer">
          ...
          <button className="responsiveTweetButton">
            <svg
              viewBox="0 0 24 24"
              aria-hidden="true"
              width="24px"
        ...
        <div className="avatarContainer">
          ...
          <div className="avatarTextContainer">
            <p className="avatarMainText">Hamid</p>
            <p className="avatarSubText">@_Dimah__</p>
          </div>
      ...
      {/* closing of buttons container for navigation */}
    </section>
  );
};
