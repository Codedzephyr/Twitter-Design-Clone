    ...
    <body>
      <main className="container">
        ...
        <div className="middleContainer">
          <Feeds />
          <div className="buttonFixedNavContainer">
            <div className="buttonFixedNavContainerMini">
              <button className="buttonFixedNav">
                <svg
                  viewBox="0 0 24 24"
                  aria-hidden="true"
                  width="24px"
          ...
          <div className="bottomNavContainer">
            <div className="bottomNavContainerSub">
              <div className="bottomNavMiniContainer">
                <svg
                  viewBox="0 0 24 24"
                  height="1.75rem"
